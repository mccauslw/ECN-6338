...
- Pour les systèmes où $n$ est grand et $A$ creuse, il y a deux options :
    - utiliser les mêmes décompositions, (Cependant, les décompositions sont souvent denses)
    - utiliser des méthodes iteratives. (Il faut utiliser ces méthodes pour les systèmes non-linéaires de toute façon).
...
- Un tiers du nombre de multiplications scalaires de la LU.
