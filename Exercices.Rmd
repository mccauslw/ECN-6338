...
1. Donnez la matrice creuse des diapos en format colonne compressée après
    a. Une insertion \texttt{A[2,4] <- 24},
    a. Une supression \texttt{A[3,2] <- 0}.
Décrit brièvement les algorithmes pour l'insertion et la supression en général.
