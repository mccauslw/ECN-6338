...
À chaque période $t$, il peut ou couper l'arbre, vendre tout le bois à un prix réel de 1 et planter un nouvel arbre ou laisser continuer à pousser l'arbre. Le taux d'intérêt réel est de $R = 5\%$.
