...
Supposez que $L_1$ et $U_1$ sont inversibles.
    a. Parmi les matrices suivantes, lequelles sont triangulaires inférieures :
    $L_1L_2$, $L_1+L_2$, $L_1^{-1}$, $L_1^\top$, $U_1^\top$, $L_1U_1$?
    a. Parmi les matrices suivantes, lequelles sont triangulaires supérieures :
...
Notez que Judd utilise le terme "back substitution" pour décrire deux algorithmes distincts.
Plusieurs auteurs font une distinction entre "back substitution" et "forward substitution".
