...
Les autres opérations sont souvents les outils de soutien
...
* un algorithme iteratif génére une suite de valeurs intermédiares $x_N$ qui converge au résultat voulu $x^* = \lim_{N\to \infty} x_N$
...
* Distinction entre la complexité d'un algorithme est la complexité d'un problème.
