...
- Problème de gestion d'un forêt
    - la décision est la quantité récoltée de chaque type (age) d'arbre,
...
- $V^U \approx \hat{V}^U \equiv W^{T+1}$ (un vecteur, l'approximation final de $V^U$)

## Code, approximation de $V^U$, version rétrograd
...
1. Utilisez $V^l$ pour calculer $U^{l+1}$, la fonction de décision sous-produite par l'itération de la fonction de valeur.
