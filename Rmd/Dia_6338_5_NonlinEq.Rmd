...
\[
  f(x) = 0,
\]
où $f \colon \mathbb{R} \to \mathbb{R}$. (En d'autres termes, trouver une racine de $f(x) = 0$.)
...
L'équilibre du jeu du monopole est la paire
\[
  (Y^*, Z^*) = (e^{x_1^*}, e^{x_2^*}),
\]
...
1. Si $f(m)$ a le même signe que $a_k$,
\[
...
- Considérez un jeu zéro-somme entre
...
\]
- $A_{k+1}$ et $A_k$ font la même chose dans les directions perpendiculaires à $s_k$ : si $s_k^\top \delta = 0$, 
\[
