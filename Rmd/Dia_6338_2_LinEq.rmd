...
## Mise en oeuvre en R, format colonne compressé par défaut
...
- $x$ est un vecteur dense, $n \times 1$.
- On veut calculer le vecteur dense $y = Ax$.
- Soit $a_i$ le $i$-ème ligne de $A$.
- On peut écrire le vecteur $y$ comme
\[
  y = Ax = \begin{bmatrix} a_1 \\ a_2 \\ \vdots \\ a_n \end{bmatrix}x.
\]
et le scalaire $y_i$ comme
\[
...
\]
- Ensemble, dans le forme $x^{k+1} = \Omega x^k + c$ :
\[
