...
- Admettons qu'on peut prouver que si $U_i \sim \mathrm{iid}\,U([0,1])$, la suite construite $\{X_i\}_{i=1}^\infty$ est iid avec la même loi que $X$.
...
| Cauchy                 | $\tfrac{1}{2} + \tfrac{1}{\pi}\tan^{-1}\left(\tfrac{x-\bar{x}}{\sigma}\right)$ | $\bar{x} + \sigma \tan\left(\pi\left(u-\tfrac{1}{2}\right)\right)$ |
