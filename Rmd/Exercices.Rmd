...
Si vous avez besoin d'aide pour ces exercices, je suggère le site Wikipédia [ici](https://en.wikipedia.org/wiki/Inverse_transform_sampling) sur la méthode .
...
1. Soit $\lambda > 0$. Soit $U \sim U([0,1])$ une variable aléatoire uniforme sur l'intervalle $[0,1]$.
