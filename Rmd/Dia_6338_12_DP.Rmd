...
- Autour de $k=k^{ss}$, $U_c(k)$ et $U_k(k)$ devraient être près des fonctions de décision optimales.
...
# Fonction de valeur initiale, épargne zéro
V_c <- u(f(k))/(1-beta)

# Fonction de valeur initiale, zéro
V_z <- rep(0, N)
```
