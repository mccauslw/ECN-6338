...
1. Maximisation de l'utilité (avec ou sans contraintes)
    ...
    a. choix travail/loisir/consommation/placements (dynamiques)
    a. choix d'action dans les jeux (enchères, négociation, signalisation)

2. Maximisation du profit (choix des quantités de production)
    a. choix de panier d'intrants (statique)
    a. choice d'investissement, de niveau de R&D (dynamiques)
    a. choix d'action dans les jeux
        i. jeux d'oligopole : cournot, bertrand, stackelberg
        i. jeux en organisation industrielle : d'entrée
...
1. [Estimation par Extremum](https://en.wikipedia.org/wiki/Extremum_estimator)
    ...
    a. moindres carrés non linéaires
    a. méthode des moments généralisés
...
1. Diapositives (code source en [R Markdown](https://rmarkdown.rstudio.com), pdf)
