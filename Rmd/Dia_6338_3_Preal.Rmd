...
- Une économie a 300 unités de $L$ (travail) et 450 unités de $T$ (terre), pour la production de blé et de boeuf.
- Produire une unité de blé ($x$) prend 2 unités de $L$, 1 unité de $T$.
- Produire une unité de boeuf ($y$) prend 1 unité de $L$, 2 unités de $T$.
