...
- On peut faire les simulations de $p(x)$ par
    ...
    - Méthodes MCMC
- L'interprétation de l'intégration par l'échantillonage préférentiel comme un changement de variables (Judd, pages 294-5) est très intéressante.
...
* Il est facile de simuler la loi avec densité $f(\theta)$.
