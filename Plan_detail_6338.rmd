...
- [Devroye](https://luc.devroye.org/rnbookindex.html) (1986), "Non-Uniform Random Number Generation"
...
Chaque étudiant a l’option de faire un projet computationnel avec une pondération de 100%.
Cette option est recommendée pour les étudiants de doctorat.
...
1. Page Wikipédia sur la méthode
[Nelder-Mead](https://en.wikipedia.org/wiki/Nelder-Mead_method)
...
1. [Devroye](https://luc.devroye.org/rnbookindex.html) II.2 and II.3 (méthode de l'inverse de la fonction de répartition, méthode de rejet)
...
## Cours 11, 12 et 13. La programmation dynamique
